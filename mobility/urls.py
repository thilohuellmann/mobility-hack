...
urlpatterns = [
    ...
    path('senior/trip/<int:id>/', views.trip_details_senior, name='trip_details_senior'), # ??? TODO
    path('senior/trip/create/step_1/', views.trip_create_1_senior, name='trip_create_1_senior'),
    path('senior/trip/create/step_2/<int:id>/', views.trip_create_2_senior, name='trip_create_2_senior'),
    path('senior/trip/create/step_3/<int:id>/', views.trip_create_3_senior, name='trip_create_3_senior'),
    path('senior/trip/create/step_4_1/<int:id>/', views.trip_create_4_1_senior, name='trip_create_4_1_senior'),
    path('senior/trip/create/step_4_2_1/<int:id>/', views.trip_create_4_2_1_senior, name='trip_create_4_2_1_senior'),
    path('senior/trip/create/step_4_2_2/<int:id>/', views.trip_create_4_2_2_senior, name='trip_create_4_2_2_senior'),
    path('senior/trip/create/step_5/<int:id>/', views.trip_create_5_senior, name='trip_create_5_senior'),
    path('senior/creation_confirmation/<int:id>/', views.trip_creation_confirmation_senior, name='trip_creation_confirmation_senior'),
